...
public class TestExercice1 {
	...
	public static void main(String[] args) {
		...
		T1.dessiner();	
    	TC.print("Tapez enter/retour pour continuer...");
    	TC.lireLigne( );
		
		T1.racine = noeuds[0];
		TC.println("test1b: la hauteur est " + T1.hauteur());
		...
		TC.println("test1c: la hauteur est " + T1.hauteur());
		...
		TC.println("test1d: la hauteur est " + T1.hauteur());
