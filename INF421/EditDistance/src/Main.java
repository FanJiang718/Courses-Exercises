...
class Main {
    ...
    {	
        ...
        System.out.println("number of edit sequences: "+ edit_count);
        return true;
    }
    ...
    public static void test4() {
        ...
        //String s1 = "Figure 1 depicts two possible sequences of edits that will transform A = abcd to B = adcb. The edit sequence on the left uses two replace operations and hence costs 2Cr. The sequence on the right uses two insert and two delete operations and hence costs 2Cd +2Ci. Depending on the relative costs, one of these sequences will be more efficient than the other. For example[ if Ci = 3 Cd = 2 Cr = 1. then the sequence on the left is more efficient cost = 2. However, if Ci = 3 Cd = 2 Cr = 6. then the sequence on the right is better cost = 10.";
        //String s2 = "Type casts are usually an indicator that you should think about an alternative solution for your problem. After all. everything which can be checked at compile time will help the programmer. However! sometimes type casts are unavoidable and in Generic code they happen often without the programmer ever";
    ...
    public static void main(String[] args) {
        ...
        test3(s1,s2);
        */
        test3(getRandomString(50000), getRandomString(10000));
        /*
